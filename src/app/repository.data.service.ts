...
import { UserModel } from './medisheduler/model/user.model';
import { AppointmentModel } from './medisheduler/model/appointment.model';
import { ResourceModel } from './medisheduler/model/resource.model';
...
export class RepositoryDataService {
  ...
  getFilteredResources(): ResourceModel[] {
